...
fn create_large_directory_structure(dir: &Path, large_dirs: usize, files_per_large_dir: usize) {
    ...
    for i in 0..large_dirs {
        ...
        for j in 0..files_per_large_dir {
            ...
            fs::write(&file_path, format!("Content of file {} in large dir {}", j, i)).unwrap();
        }
    }
    ...
    for i in 0..5 {
        ...
        for j in 0..100 {
            ...
            fs::write(&file_path, format!("Content of file {} in small dir {}", j, i)).unwrap();
        }
    }
}
...
fn create_uneven_directory_structure(dir: &Path) {
    ...
    for i in 0..20 {
        ...
        for j in 0..50 {
            ...
            fs::write(&file_path, format!("Content of small file {} in dir {}", j, i)).unwrap();
        }
    }
}
